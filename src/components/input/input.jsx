const Input = props=>{
    return(
        <form onSubmit={props.onFormSubmitHanlder} className="notes-input flex flex-col gap-2 lg:px-48 md:px-32 px-4 mt-4 items-center">
            ...
            <button onClick={props.onFormSubmitHanlder} className="bg-white py-2 rounded-lg shadow-md w-full text-slate-950 font-bold hover:bg-gray-200">Add</button>
        </form>
    );
}
